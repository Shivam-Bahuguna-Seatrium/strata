        ...
        <div className="section-inner w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <motion.div className="flex flex-wrap gap-2 md:gap-3 mb-4 md:mb-5"
              ...
              {['🧊 Zero Sugar', '💯 Vegan', '🌾 Gluten-Free', '⚡Fast', '🔬 Science'].map((badge, i) => {
            ...
            <motion.div
              ...
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-blue-900 leading-[1.05] mb-3 md:mb-4" style={{ letterSpacing: '-0.02em' }}>
                Peak<br className="hidden sm:block" />
                <span className="gradient-neon">Hydration</span>
              </h1>
            </motion.div>
            ...
            <motion.p
              ...
              Science-formulated electrolytes. 6 flavors. Premium taste. Join 50K+ athletes who hydrate smarter.
            </motion.p>
            <div className="h-2"></div>
            ...
            <motion.div
              ...
              <motion.a href="#benefits"
                className="px-8 md:px-10 py-3 md:py-4 rounded-xl font-extrabold text-base md:text-lg transition-all text-center transition-all"
                style={{
                  color: '#FFFFFF',
            ...
            <motion.div
              ...
              <div className="text-center">
                ...
                <div className="text-blue-900 text-sm md:text-base font-black">STRATA PREMIUM</div>
                <div className="text-blue-600 text-xs md:text-sm mt-2 font-semibold">Stick Pack Hydration</div>
              </div>
            </motion.div>

            {/* Floating badges */}
            {[
              { label: '⚡ Fast', pos: 'top-4 right-4 sm:-top-8 sm:-right-8', color: '#0077FF' },
              { label: '✨ Premium', pos: 'bottom-4 left-4 sm:-bottom-8 sm:left-0', color: '#00E5FF' },
              { label: '💪 Strong', pos: 'top-1/3 -left-12 sm:-left-16', color: '#FF1493' },
            ].map((badge, i) => (
              <motion.div
                key={badge.label}
                animate={{ y: [0, -20, 0] }}
                transition={{ duration: 4 + i, repeat: Infinity, ease: 'easeInOut', delay: i * 0.3 }}
                className={`absolute ${badge.pos} px-4 py-2 rounded-full text-xs md:text-sm font-bold text-gray-900`}
                style={{ background: `${badge.color}28`, border: `1.5px solid ${badge.color}55`, boxShadow: `0 6px 20px ${badge.color}33` }}>
                {badge.label}
              </motion.div>
            ))}
            </motion.div>
